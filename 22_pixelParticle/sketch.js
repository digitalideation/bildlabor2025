// After https://editor.p5js.org/BarneyCodes/sketches/k0ImyGuo9
...
class Particle {
  ...
  update() {
    ...
    // forces
    let mouseF = constrain(map(mouseD, 0, 100, 10, 0), 0, 10)*noise(frameCount * 0.01, this.x*this.y);
